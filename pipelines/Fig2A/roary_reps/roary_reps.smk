...
rule roary:
    ...
    """
    input:
        gff_files=expand("/vast/palmer/scratch/turner/flg9/snakemake_workflows/pangenome_alignment/GitHub/pipelines/SP/prokka_roary/results/SP/prokka_roary/prokka/{sample}/{sample}.gff", sample=SAMPLES)
    output:
...
rule fastree:
    ...
    output:
        nwk = "results/SP/roary_reps/roary/GPSC_pneumo_tree.newick"
    conda:
        "envs/roary.yaml"
    log:
...
rule fastani_refseq_reps:
    ...
    """
    input:
        queryseqs = "parnas_reps.txt",
        ref = "GPSCs/reps/NC_017592.fasta"
    output:
